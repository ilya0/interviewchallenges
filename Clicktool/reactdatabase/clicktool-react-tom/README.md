...
|`prod`             |Serves app in production mode|
...
│   ├── middleware           # Middleware utilities used within event flow chains
│   ├── routes               # Main route definitions and async split points
│   │   ├── index.js         # Bootstrap main application routes with store
│   │   ├── Login            # Fractal route for Login
│   │   │   ├── index.js     # Login route definition
│   │   │   ├── containers   # Connect components to actions and store
|   |   │   └── components   # Components for this specific feature
│   │   ├── Cost             # Fractal route for Cost Index
│   │   │   ├── index.js     # Route definitions and async split points
│   │   │   ├── components   # Presentational React Components
|   |   │   ├── containers   # Containers for this specific feature
│   │   │   └── routes **    # Fractal sub-routes (** this is optional)
│   │   ├── ORCI             # Fractal route for ORCI
│   │   │   ├── index.js     # ORCI route definition
│   │   │   ├── containers   # Connect components to actions and store
|   |   │   └── components   # Components for this specific feature
│   │   └── Predictive       # Fractal route for Predictive Index
│   │       ├── index.js     # Predictive route definition
│   │       ├── containers   # Connect components to actions and store
|   |       └── components   # Components for this specific feature
│   ├── store                # Redux-specific pieces
│   │   ├── createStore.js   # Create and instrument redux store
│   │   └── reducers.js      # Reducer registry and injection
│   │   └── hosts.js      # Reducer registry and injection
│   └── styles               # Application-wide styles (generally settings)
│   └── stubs                # Data stubs (typically JSON)
